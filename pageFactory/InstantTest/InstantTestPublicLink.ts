...
export class InstantTestPublicLinkPage {
    readonly page: Page;
    ...
    private _getSourceNameFromPublicLinkPage = '//label[contains(@class,"PublicSyntheticInstantTeststyles__ShareLabelContainer-sc")]'
