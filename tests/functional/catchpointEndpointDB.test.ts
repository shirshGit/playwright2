...
test.describe('Navigate to Overview DB', () => {

    test(`@Smoke @Login Test1`, async ({page, loginPage, instantTabWindow }) => {
    
        // var loginPageObjects = new LoginPageObjects();
        // await loginPage.navigateToCPUrl();
        // await loginPage.loginToCP();
        
        await loginPage.navigateToEndpointOverviewDB();

        await instantTabWindow.clickOnSystemDropDown();
        
        await page.waitForTimeout(4000);

        //await loginPage.openDivisionList();
