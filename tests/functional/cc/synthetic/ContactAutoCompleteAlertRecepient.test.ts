...
test("VerifyContactAutocompleteForAlertRecepient  @Smoke@SyntheticControlCenter", async({baseTestUtil, syntheticTestDetailPage,util, sideNavigationBar, verification}) => {
