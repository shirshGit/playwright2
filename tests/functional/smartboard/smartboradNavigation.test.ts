...
*/
test("VerifyGuageTileNavigationToSBByThreeDotMenu @PageNavigation", async({baseTestUtil,sideNavigationBar, verification, defaultDashboardPage,synWidgetPropertyPage, util,testUtility,customDBPage,syntheticSmartboardPage,dashboardBlade}) => {
    let metrics : string[] = ['Experience Score'];
    let otherFilters : string = 'Country';
    let otherFilterOptions : string[] = ['United State'];
    let vizName = 'Gauge';
...
*/
test("VerifyTileNavigationToSBByThreeDotMenu @PageNavigation", async({baseTestUtil,sideNavigationBar, verification, defaultDashboardPage,synWidgetPropertyPage, util,testUtility,customDBPage,syntheticSmartboardPage,dashboardBlade}) => {
    let metrics : string[] = ['Test Time (ms)'];
    let otherFilters : string = 'Country';
    let otherFilterOptions : string[] = ['United State'];
    let vizName = 'Tile';
